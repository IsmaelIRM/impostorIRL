...
class CleanMission extends MissionModule {
  static type = "CLEAN";
  static metadata = {
    name: "Limpiafondos",
    icon: "🥽",
  ...
  constructor(mission) {
    super(mission);
    this.zoneSpecific = mission.zoneSpecific || "Piscina";
  ...
  render(ctx) {
    ...
    return `<div class="mission ${statusClass}" data-mission-id="${this.id}" data-type="${this.type}">
      <div class="meta">Limpiafondos · ${this.escapeHtml(this.zoneSpecific)}</div>
